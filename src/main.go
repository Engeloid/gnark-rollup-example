...
func main() {
	...
	assignment.AllocateSlicesMerkleProofss()
	// Transactions
	assignment.Amount = operatorA.Witnesses.Transfers[0].Amount
	assignment.Signature = operatorA.Witnesses.Transfers[0].Signature

	// rest of account constraints
	assignment.SenderAccountsBefore.Index = operatorA.Witnesses.SenderAccountsBefore[0].Index
	assignment.SenderAccountsBefore.Nonce = operatorA.Witnesses.SenderAccountsBefore[0].Nonce
	assignment.SenderAccountsBefore.Balance = operatorA.Witnesses.SenderAccountsBefore[0].Balance
	assignment.ReceiverAccountsBefore.Index = operatorA.Witnesses.ReceiverAccountsBefore[0].Index
	assignment.ReceiverAccountsBefore.Nonce = operatorA.Witnesses.ReceiverAccountsBefore[0].Nonce
	assignment.ReceiverAccountsBefore.Balance = operatorA.Witnesses.ReceiverAccountsBefore[0].Balance
	assignment.SenderAccountsAfter.Index = operatorA.Witnesses.SenderAccountsAfter[0].Index
	assignment.SenderAccountsAfter.Nonce = operatorA.Witnesses.SenderAccountsAfter[0].Nonce
	assignment.SenderAccountsAfter.Balance = operatorA.Witnesses.SenderAccountsAfter[0].Balance
	assignment.ReceiverAccountsAfter.Index = operatorA.Witnesses.ReceiverAccountsAfter[0].Index
	assignment.ReceiverAccountsAfter.Nonce = operatorA.Witnesses.ReceiverAccountsAfter[0].Nonce
	assignment.ReceiverAccountsAfter.Balance = operatorA.Witnesses.ReceiverAccountsAfter[0].Balance

	// assign public key values of senders and receivers respectively
	assignment.SenderPubKey = operatorA.Witnesses.PublicKeysSender[0]
	assignment.ReceiverPubKey = operatorA.Witnesses.PublicKeysReceiver[0]

	// Merkle proofs, roots and leafs
	assignment.MerkleProofReceiverBefore = operatorA.Witnesses.MerkleProofReceiverBefore[0]
	assignment.MerkleProofReceiverAfter = operatorA.Witnesses.MerkleProofReceiverAfter[0]
	assignment.MerkleProofSenderBefore = operatorA.Witnesses.MerkleProofSenderBefore[0]
	assignment.MerkleProofSenderAfter = operatorA.Witnesses.MerkleProofSenderAfter[0]
	assignment.LeafReceiver = operatorA.Witnesses.LeafReceiver[0]
	assignment.LeafSender = operatorA.Witnesses.LeafSender[0]

	// PUBLIC INPUTS
	assignment.RootHashesBefore = operatorA.Witnesses.RootHashesBefore[0]
	assignment.RootHashesAfter = operatorA.Witnesses.RootHashesAfter[0]
	...
	// generate the proof
	fmt.Println("Public witness created: ", publicWitness)
